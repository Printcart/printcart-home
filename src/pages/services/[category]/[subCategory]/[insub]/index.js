...
export async function getServerSideProps({ query }) {
  ...
  const results = await fetch(`${paramStrapi}project-categories?populate=parent.parent&filters[parent][parent][alias][$notNull]=true&filters[parent][alias][$notNull]=true&filters[alias][$eq]=${insub}`).then((res) => res.json());
